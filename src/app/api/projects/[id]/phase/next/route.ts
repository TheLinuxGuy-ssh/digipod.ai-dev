...
// POST /api/projects/[id]/phase/next - AI-driven or manual phase advance
export async function POST(
  ...
  if (force) {
    ...
    return NextResponse.json({ success: true, nextPhase, aiReply: 'Manually advanced', trigger: 'manual' });
  }
